  ...
  return (
    <>
      <Container>
        ...
        <BoxWrapper>
          {/* Box 1 */}
          <Box onClick={() => handleBoxClick("Packing list details")}>
            <Top>
            ...
            <Bottom>
              ...
              <Text>A full list of what you will need to ensure a comfortable trip.</Text>
            </Bottom>
          </Box>

          {/* Box 2 */}
          <Box onClick={() => handleBoxClick("Booking policy details")}>
            <Top>
            ...
            <Bottom>
              ...
              <Text>Learn more about booking procedure, payment terms, cancellation and refund policy.</Text>
            </Bottom>
          </Box>
        </BoxWrapper>
      </Container>
      ...
      {/* Modal */}
      {isModalOpen && (
        <ModalWahtToKnow onClose={handleCloseModal}>
          <p>{modalContent}</p>
        </ModalWahtToKnow>
      )}
    </>
