...
import {
  ...
  Share,
  Text,
} from "../../styles/TripDetail/BriefItinerary";
        ...
        <RBox theme={theme}>
          ...
          <InputWrapper theme={theme}>
            <Inputbox theme={theme}>
              ...
              <Input placeholder="Enter your referral code" type="text" theme={theme} />
            </Inputbox>
          ...
          <DetailWrapper theme={theme}>
            <H3 theme={theme}>
              Cost per person
              <span theme={theme}>(Prices include all extras)</span>
            </H3>
            <PriceDetail theme={theme}>
              <PLeft theme={theme}>
                <strong theme={theme}>Adult</strong>
                <span theme={theme}>Over 12 years old</span>
              </PLeft>
              <PRight theme={theme}>$1,817 USD</PRight>
            </PriceDetail>

            <PriceDetail theme={theme} style={{ borderBottom: "0" }}>
              <PLeft theme={theme}>
                <strong>Total</strong>
              </PLeft>
            ...
            <Another theme={theme}>
              <Link to="/find-trip" style={{ textDecoration: "none", color: "inherit" }}>
                Need another option? Try our Concierge
              </Link>
            </Another>
            <Text theme={theme}>
              Offer is made subject to availability at the time of booking. Added trip extras are
              finalized on request.
            </Text>
            <Share theme={theme}>
              <svg
                aria-hidden="true"
                ...
                className="svg-inline--fa fa-share-from-square"
                role="img"
